...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Oct 29 15:25:52 EDT 2016
  */
  ...
  public final java_cup.runtime.Symbol CUP$mj$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$mj$act_num)
		...
		System.out.println("before : list is "+_statements+"  and statement list is ");
		//_statements.addAll(block);
		System.out.println("After : list is "+_statements+"  and statement list is " );
		...
		LinkedList<VarDecl> _varDecls = new LinkedList<VarDecl>();
		LinkedList<MethodDecl> _methodDecls = new LinkedList<MethodDecl>();
		System.out.println("before : methods is "+_methodDecls+"  and statement list is "+methods );
		_methodDecls.add(methods);
		System.out.println("after : methods is "+_methodDecls+"  and statement list is "+methods );		
